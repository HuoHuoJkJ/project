...
int main(int argc, const char *argv[])
{
    ...
    if (argc != 5)
    {
        printf("Use:./crtsurfdata5 inifile outpath logfile datafmt\n");
        printf("Example:/project/idc1/bin/crtsurfdata5 /project/idc1/ini/stcode.ini /tmp/idc1/surfdata /log/idc/crtsurfdata5.log xml,json,csv\n\n");
    ...
    if (strstr(argv[4], "xml") != 0)
        CtrSurfFile(argv[2], "xml");
    if (strstr(argv[4], "json") != 0)
        CtrSurfFile(argv[2], "json");
    if (strstr(argv[4], "csv") != 0)
        CtrSurfFile(argv[2], "csv");
