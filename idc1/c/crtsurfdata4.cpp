...
int main(int argc, const char *argv[])
{
    ...
    if (argc != 5)
    {
        printf("Use:./crtsurfdata4 inifile outpath logfile datafmt\n");
        printf("Example:/project/idc1/bin/crtsurfdata4 /project/idc1/ini/stcode.ini /tmp/idc1/surfdata /log/idc/crtsurfdata4.log xml,json,csv\n\n");
