...
int main(int argc,char *argv[])
{
  ...
  if (argc!=5)
  {
    ...
    printf("Example:/project/tools1/bin/procctl 10 /project/idc1/bin/obtmindtodb2 /idcdata/surfdata \"127.0.0.1,root,DYT.9525ing,TestDB,3306\" utf8 /log/idc/obtmindtodb.log\n\n");
