...
bool _tcpputfiles()
{
    ...
    while (true)
    {
        ...
        logfile.Write("_tcpputfiles---(发送):strsendbuffer=%s\n", strsendbuffer);
        if (TcpClient.Write(strsendbuffer) == false)
        { logfile.Write("TcpClient.Write(%s) falied.\n", strsendbuffer); return false; }
        ...
        logfile.Write("_tcpputfiles---(接收):strrecvbuffer=%s\n", strrecvbuffer);
