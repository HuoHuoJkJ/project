...
// 业务处理主函数
bool _syncincrementex_oracle(bool &bcontinue);
...
int main(int argc, char *argv[])
{
	...
	{
		// 业务处理主函数
		if (_syncincrementex_oracle(bcontinue) == false) _exit(0);
...
void _help()
{
	printf("Use:syncincrementex_oracle logfilename xmlbuffer\n\n");
	printf("Sample:\n");

	printf("/project/tools1/bin/procctl 10 /project/tools1/bin/syncincrementex_oracle /log/idc/syncincrementex_oracle_ZHOBTMIND2.log \"<localconnstr>scott/dyting9525@snorcl11g_43</localconnstr><remoteconnstr>qxidc/dyting9525@snorcl11g_43</remoteconnstr><charset>Simplified Chinese_China.AL32UTF8</charset><remotetname>T_ZHOBTMIND1</remotetname><localtname>T_ZHOBTMIND2</localtname><remotecols>obtid,ddatetime,t,p,u,wd,wf,r,vis,upttime,keyid</remotecols><localcols>obtid,ddatetime,t,p,u,wd,wf,r,vis,upttime,keyid</localcols><remotekeycol>keyid</remotekeycol><localkeycol>keyid</localkeycol><timetvl>2</timetvl><timeout>50</timeout><pname>syncincrementex_oracle_ZHOBTMIND2</pname>\"\n\n");

	printf("/project/tools1/bin/procctl 10 /project/tools1/bin/syncincrementex_oracle /log/idc/syncincrementex_oracle_ZHOBTMIND3.log \"<localconnstr>scott/dyting9525@snorcl11g_43</localconnstr><remoteconnstr>qxidc/dyting9525@snorcl11g_43</remoteconnstr><charset>Simplified Chinese_China.AL32UTF8</charset><remotetname>T_ZHOBTMIND1</remotetname><localtname>T_ZHOBTMIND3</localtname><remotecols>obtid,ddatetime,t,p,u,wd,wf,r,vis,upttime,keyid</remotecols><localcols>obtid,ddatetime,t,p,u,wd,wf,r,vis,upttime,keyid</localcols><where>and obtid like '54%%'</where><remotekeycol>keyid</remotekeycol><localkeycol>keyid</localkeycol><timetvl>2</timetvl><timeout>50</timeout><pname>syncincrementex_oracle_ZHOBTMIND3</pname>\"\n\n");
