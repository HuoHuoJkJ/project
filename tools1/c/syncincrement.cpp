...
int main(int argc, char *argv[])
{
	...
	{
		// 业务处理主函数
		if (_syncincrement(bcontinue) == false) _exit(0);
...
bool _syncincrement(bool &bcontinue)
{
	...
	// 		select starg.remotecols from starg.fedtname
