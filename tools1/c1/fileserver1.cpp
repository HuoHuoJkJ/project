...
int main(int argc, char *argv[])
{
    if (argc != 3)
    {
        ...
        printf("Example:./fileserver1 5005 /log/tools/fileserver1.log\n");
        printf("         /project/tools1/bin/procctl 10 /project/tools1/bin/fileserver1 5005 /log/idc/fileserver.log\n\n\n");
        return -1;
    }
